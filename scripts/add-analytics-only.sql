-- ADD ONLY these 4 NEW analytics tables to your EXISTING Supabase database
-- Your existing tables (products, suppliers, activity_logs, cart_items) are NOT touched
...
-- 3. Supplier performance metrics over time
